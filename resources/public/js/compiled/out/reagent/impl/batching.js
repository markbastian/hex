...
var c_8698 = (a[i]);
if(cljs.core.truth_((c_8698["cljsIsDirty"]))){
(c_8698["forceUpdate"])();
} else {
}
...
var G__8702 = c;
var G__8702__$1 = (((G__8702 == null))?null:(G__8702["props"]));
if((G__8702__$1 == null)){
return null;
} else {
return (G__8702__$1["argv"]);
}
});
...
var G__8704_8705 = (c["cljsRatom"]);
if((G__8704_8705 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__8704_8705);
}

return reagent.impl.batching.mark_rendered.call(null,c);
});

//# sourceMappingURL=batching.js.map?rel=1462424428854