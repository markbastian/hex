...
var or__41419__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__41419__auto__)){
return or__41419__auto__;
} else {
var or__41419__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__41419__auto____$1)){
return or__41419__auto____$1;
} else {
var or__41419__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__41419__auto____$2)){
return or__41419__auto____$2;
} else {
var or__41419__auto____$3 = (w["msRequestAnimationFrame"]);
...
var n__42432__auto__ = a.length;
var i = (0);
while(true){
if((i < n__42432__auto__)){
var c_76101 = (a[i]);
if(cljs.core.truth_((c_76101["cljsIsDirty"]))){
(c_76101["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__42071__auto__,writer__42072__auto__,opt__42073__auto__){
return cljs.core._write.call(null,writer__42072__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__76105 = c;
var G__76105__$1 = (((G__76105 == null))?null:(G__76105["props"]));
if((G__76105__$1 == null)){
return null;
} else {
return (G__76105__$1["argv"]);
}
});
...
var G__76107_76108 = (c["cljsRatom"]);
if((G__76107_76108 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__76107_76108);
}

return reagent.impl.batching.mark_rendered.call(null,c);
});

//# sourceMappingURL=batching.js.map?rel=1467866137839