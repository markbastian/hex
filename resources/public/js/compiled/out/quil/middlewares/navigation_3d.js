...
var vec__80262 = axis;
var a_x = cljs.core.nth.call(null,vec__80262,(0),null);
var a_y = cljs.core.nth.call(null,vec__80262,(1),null);
var a_z = cljs.core.nth.call(null,vec__80262,(2),null);
var vec__80265 = v;
var x = cljs.core.nth.call(null,vec__80265,(0),null);
var y = cljs.core.nth.call(null,vec__80265,(1),null);
var z = cljs.core.nth.call(null,vec__80265,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__80268,p__80269){
var vec__80276 = p__80268;
var u1 = cljs.core.nth.call(null,vec__80276,(0),null);
var u2 = cljs.core.nth.call(null,vec__80276,(1),null);
var u3 = cljs.core.nth.call(null,vec__80276,(2),null);
var vec__80279 = p__80269;
var v1 = cljs.core.nth.call(null,vec__80279,(0),null);
var v2 = cljs.core.nth.call(null,vec__80279,(1),null);
var v3 = cljs.core.nth.call(null,vec__80279,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__80282_SHARP_){
return (p1__80282_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return (function (p1__80283_SHARP_){
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__80283_SHARP_,axis,angle);
});})(axis))
;
...
return (function (p1__80284_SHARP_){
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__80284_SHARP_,angle_lr),angle_ud);
...
var map__80291 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__80291__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__80291__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__6475__auto__ = (function (){var pred__80293 = cljs.core._EQ_;
var expr__80294 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__80293.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__80294))){
return straight;
} else {
if(cljs.core.truth_(pred__80293.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__80294))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__80293.call(null,quil.middlewares.navigation_3d.space,expr__80294))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__80293.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__80294))){
return up;
} else {
if(cljs.core.truth_(pred__80293.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__80294))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__80293.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__80294))){
...
var dir = temp__6475__auto__;
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__6475__auto__,map__80291,map__80291__$1,up,straight){
return (function (p1__80285_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__80285_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__6475__auto__,map__80291,map__80291__$1,up,straight))
);
} else {
return state;
}
...
return (function (p1__80296_SHARP_){
return cljs.core.merge.call(null,initial_state,p1__80296_SHARP_);
});})(initial_state))
);
});
/**
...
var map__80308_80319 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__80308_80320__$1 = ((((!((map__80308_80319 == null)))?((((map__80308_80319.cljs$lang$protocol_mask$partition0$ & (64))) || (map__80308_80319.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__80308_80319):map__80308_80319);
var vec__80309_80321 = cljs.core.get.call(null,map__80308_80320__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_80322 = cljs.core.nth.call(null,vec__80309_80321,(0),null);
var c_y_80323 = cljs.core.nth.call(null,vec__80309_80321,(1),null);
var c_z_80324 = cljs.core.nth.call(null,vec__80309_80321,(2),null);
var vec__80312_80325 = cljs.core.get.call(null,map__80308_80320__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_80326 = cljs.core.nth.call(null,vec__80312_80325,(0),null);
var u_y_80327 = cljs.core.nth.call(null,vec__80312_80325,(1),null);
var u_z_80328 = cljs.core.nth.call(null,vec__80312_80325,(2),null);
var vec__80315_80329 = cljs.core.get.call(null,map__80308_80320__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_80330 = cljs.core.nth.call(null,vec__80315_80329,(0),null);
var p_y_80331 = cljs.core.nth.call(null,vec__80315_80329,(1),null);
var p_z_80332 = cljs.core.nth.call(null,vec__80315_80329,(2),null);
quil.core.camera.call(null,p_x_80330,p_y_80331,p_z_80332,(p_x_80330 + c_x_80322),(p_y_80331 + c_y_80323),(p_z_80332 + c_z_80324),u_x_80326,u_y_80327,u_z_80328);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1467866141136