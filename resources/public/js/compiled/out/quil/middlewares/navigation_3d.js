...
var vec__45219 = axis;
var a_x = cljs.core.nth.call(null,vec__45219,(0),null);
var a_y = cljs.core.nth.call(null,vec__45219,(1),null);
var a_z = cljs.core.nth.call(null,vec__45219,(2),null);
var vec__45220 = v;
var x = cljs.core.nth.call(null,vec__45220,(0),null);
var y = cljs.core.nth.call(null,vec__45220,(1),null);
var z = cljs.core.nth.call(null,vec__45220,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__45221,p__45222){
var vec__45225 = p__45221;
var u1 = cljs.core.nth.call(null,vec__45225,(0),null);
var u2 = cljs.core.nth.call(null,vec__45225,(1),null);
var u3 = cljs.core.nth.call(null,vec__45225,(2),null);
var vec__45226 = p__45222;
var v1 = cljs.core.nth.call(null,vec__45226,(0),null);
var v2 = cljs.core.nth.call(null,vec__45226,(1),null);
var v3 = cljs.core.nth.call(null,vec__45226,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__45227_SHARP_){
return (p1__45227_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__45228_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__45229_SHARP_,angle_lr),angle_ud);
...
var map__45236 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__45236__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__45236__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__45238 = cljs.core._EQ_;
var expr__45239 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__45238.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__45239))){
return straight;
} else {
if(cljs.core.truth_(pred__45238.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__45239))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__45238.call(null,quil.middlewares.navigation_3d.space,expr__45239))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__45238.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__45239))){
return up;
} else {
if(cljs.core.truth_(pred__45238.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__45239))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__45238.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__45239))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__45236,map__45236__$1,up,straight){
return (function (p1__45230_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__45230_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__45236,map__45236__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__45241_SHARP_);
});})(initial_state))
);
});
/**
...
var map__45247_45252 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__45247_45253__$1 = ((((!((map__45247_45252 == null)))?((((map__45247_45252.cljs$lang$protocol_mask$partition0$ & (64))) || (map__45247_45252.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__45247_45252):map__45247_45252);
var vec__45248_45254 = cljs.core.get.call(null,map__45247_45253__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_45255 = cljs.core.nth.call(null,vec__45248_45254,(0),null);
var c_y_45256 = cljs.core.nth.call(null,vec__45248_45254,(1),null);
var c_z_45257 = cljs.core.nth.call(null,vec__45248_45254,(2),null);
var vec__45249_45258 = cljs.core.get.call(null,map__45247_45253__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_45259 = cljs.core.nth.call(null,vec__45249_45258,(0),null);
var u_y_45260 = cljs.core.nth.call(null,vec__45249_45258,(1),null);
var u_z_45261 = cljs.core.nth.call(null,vec__45249_45258,(2),null);
var vec__45250_45262 = cljs.core.get.call(null,map__45247_45253__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_45263 = cljs.core.nth.call(null,vec__45250_45262,(0),null);
var p_y_45264 = cljs.core.nth.call(null,vec__45250_45262,(1),null);
var p_z_45265 = cljs.core.nth.call(null,vec__45250_45262,(2),null);
quil.core.camera.call(null,p_x_45263,p_y_45264,p_z_45265,(p_x_45263 + c_x_45255),(p_y_45264 + c_y_45256),(p_z_45265 + c_z_45257),u_x_45259,u_y_45260,u_z_45261);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1462424041978